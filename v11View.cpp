...
Cv11View::Cv11View() {
	color = color_prev = shape = shape_prev = 0;
}
...
{
	CRectTracker rtcr;
	if (rtcr.TrackRubberBand(this, point))
		rc = rtcr.m_rect;
	Invalidate();
}
...
void Cv11View::OnColor()
{
	...
	CMFCRibbonColorButton* pColorBtn = (CMFCRibbonColorButton*)arr.GetAt(0);
	color_prev = pColorBtn->GetColor();
	color = color_prev;
	Invalidate();
}
